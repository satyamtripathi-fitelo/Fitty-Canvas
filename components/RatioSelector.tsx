    ...
    <div className="space-y-3">
      <div className="relative">
        <button
          ...
          className="flex w-full items-center justify-between gap-3 rounded-xl border bg-background px-3 py-2.5 text-left text-sm shadow-sm transition hover:border-primary focus:outline-none focus:ring-2 focus:ring-primary/30"
        >
          <span className="min-w-0">
            <span className="block text-[11px] font-medium uppercase text-muted-foreground">Aspect ratio</span>
            <span className="mr-2 font-semibold">{selectedLabel}</span>
        ...
        {open ? (
          <div className="absolute left-0 right-0 top-[calc(100%+8px)] z-50 rounded-2xl border bg-card p-2 shadow-2xl ring-1 ring-primary/10">
              ...
              {presets.map((preset) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      "rounded-xl border px-2.5 py-2 text-left text-xs shadow-sm transition",
                      selected
